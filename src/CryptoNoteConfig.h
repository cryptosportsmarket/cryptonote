...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xb7055;
...
const char     CRYPTONOTE_NAME[]                             = "cryptoSportsmarket";
...
const int      P2P_DEFAULT_PORT                              = 22306;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 22307;
